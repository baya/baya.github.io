...
生成交易自身数据的逻辑比较简单，如同做填空题一样，将它们填写好就可以了，所以暂时不讨论它们，我们把主要精力放到 Txin 和 Txout 这两种数据上。

### 2.1 Txin 和 Txout 的逻辑分析
...
由于我并没有中本聪的私钥，所以我没有办法用代码去演示怎么转移掉 TX0 中的 50 个比特币，但是我们仍然可以对 [Block#170](https://webbtc.com/block/00000000d1145790a8694403d4063f323d499e655c83426834d4ce2f8dd4a2ee) 中的已经发生的交易用代码进行分析并逐步演示怎么创建可用的交易。

![block#170交易演示](/images/block_170_tx.jpg)

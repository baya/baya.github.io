...
现在我们尝试下手工解码 0x1b0404cb, 0x1b = 27, 27 - 3 = 24, 24 * 2 = 48, 我们在 0404cb 后面追加 48 个零就得到了 0x404cb000000000000000000000000000000000000000000000000
...
上面公式的详细推导过程可以在 [https://en.bitcoin.it/wiki/Difficulty](https://en.bitcoin.it/wiki/Difficulty) 找到.
...
上面的这些大数都可以在 [https://en.wikipedia.org/wiki/Names_of_large_numbers](https://en.wikipedia.org/wiki/Names_of_large_numbers) 找到对应的定义。

比特币的算力运算现在都是在专用都矿机上进行的，所以了解下专用矿机的各项指标对我们以后改进比特币也许会有帮助，下面是一组 2016 的主流矿机的指标数据。

数据来源于 [https://99bitcoins.com/2016-bitcoin-mining-hardware-comparison/](https://99bitcoins.com/2016-bitcoin-mining-hardware-comparison/),
...
目前主流的矿机算力都是 TH/s, 普通用户只能通过购买的方式才能得到比特币。但是在这篇文章中我们可以自行设定 difficulty 为一个较小的数，这样我们可以在自己的电脑上"挖矿".

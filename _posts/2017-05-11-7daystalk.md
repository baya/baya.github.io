...
1\. 交易自身的数据, 比如: Version no, In-counter, Out-counter, lock_time;

2\. inputs 数据, 比如: list of inputs;

3\. outputs 数据, 比如: list of outputs;

当我们完成上述三部分数据的构造时，还需要对交易进行验证，确认交易是否符合比特币的协议.

...
现在我们来详细分析 [kyk_exe_p2pkh_sc_test.c](https://github.com/baya/block7days/blob/master/protocols/kyk_gens_tx/kyk_exe_p2pkh_sc_test.c) 这个程序的逻辑. 在此程序中当前交易即要被签名的交易是 [Tx-d37d](https://blockexplorer.com/api/tx/1e4f607d33175aa3b0a854c7d494ee0eb0ac3f0fc0a759ad1ddf88efbe8cd37d), 为了让读者更清楚地理解比特币的签名过程，我画了一张图来描述这一签名过程.
...
我们成功验证了交易 [Tx-d37d](https://blockexplorer.com/api/tx/1e4f607d33175aa3b0a854c7d494ee0eb0ac3f0fc0a759ad1ddf88efbe8cd37d) 的 pay-to-pubkey-hash 脚本.
